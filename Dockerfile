...
RUN set -eux; addgroup -g 8080 app ; adduser -u 8080 -S -G app app ;\
    ...
    mkdir -p /usr/local/apache-tomcat /app/war /app/tomcat/conf /app/tomcat/logs /app/tomcat/work /app/tomcat/bin ; tar zxf /tmp/apache-tomcat-${TOMCAT_VER}.tar.gz -C /usr/local/apache-tomcat --strip-components 1 ;\
